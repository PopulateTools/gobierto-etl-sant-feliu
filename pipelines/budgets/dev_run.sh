...
cd $GOBIERTO_ETL_UTILS; ruby operations/gobierto_budgets/update_total_budget/run.rb "2017 2018 2019 2020" $STORAGE_DIR/organization.id.txt
...
cd $DEV_DIR/gobierto; bin/rails runner $GOBIERTO_ETL_UTILS/operations/gobierto_budgets/annual_data/run.rb "2017 2018 2019 2020" $STORAGE_DIR/organization.id.txt
